...
export class ChatService {
  ...
  modelList: LlmModel[] = [
    ...
    { tag: '思考', class: 'wis', isEnable: true, maxTokens: 100000, maxInputTokens: 200000, isGSearch: false, isDomestic: false, isPdf: true, price: [0.0165000, 0.066000, 0.0165000, 0.066000], id: 'o1', },
    // { tag: '思考', class: 'wis', isEnable: true, maxTokens: 100000, maxInputTokens: 200000, isGSearch: false, isDomestic: false, isPdf: true, price: [0.0011000, 0.004400, 0.0011000, 0.004400], id: 'o1-pro', },
    { tag: '思考', class: 'wis', isEnable: true, maxTokens: 100000, maxInputTokens: 200000, isGSearch: false, isDomestic: false, isPdf: true, price: [0.1500000, 0.600000, 0.1500000, 0.600000], id: 'o3-mini', },
